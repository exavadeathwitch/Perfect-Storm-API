...
DWORD WINAPI ccMain::Main()
{
	...
	// Initialize CasualGamer Memory
	//CasualGamer::InitializeMemory();

	// Get Client Address of Storm 4
	//CasualGamer::GetClientAddress();
	return 0;
}
...
void ReadPartnerSlotParam(string _file)
{
	...
	for (int x = 0; x < slotCount; x++)
	{
		...
		if (slotType == "PARTNER_TYPE_2PAR") slotFunct = 0x7F0064;		//0x7EE7C8
		else if (slotType == "PARTNER_TYPE_2KKG") slotFunct = 0x7F00BC; //0x7EE820
		else if (slotType == "PARTNER_TYPE_2AKM") slotFunct = 0x7F0114; //0x7EE878
		else if (slotType == "PARTNER_TYPE_2KRS") slotFunct = 0x7F016C; //0x7EE8D0
		else if (slotType == "PARTNER_TYPE_1AKM") slotFunct = 0x7F01C4; //0x7EE928
		else if (slotType == "PARTNER_TYPE_1KRS") slotFunct = 0x7F021C; //0x7EE980
		else if (slotType == "PARTNER_TYPE_2SCX") slotFunct = 0x7F0274; //0x7EE9D8
		else if (slotType == "PARTNER_TYPE_8AEM") slotFunct = 0x7F02CC; //0x7EEA30
...
void ReadSpecialConditionParam(string _file)
{
	...
	for (int x = 0; x < slotCount; x++)
	{
		...
		if (slotType == "COND_1CMN") condFunct = 0x7C4B7C; //0x7C2C58
		else if (slotType == "COND_2SIK") condFunct = 0x7C4BE4; //0x7C2CC0
		else if (slotType == "COND_2HDN") condFunct = 0x7C4C4C; //0x7C2D28
		else if (slotType == "COND_2KKS") condFunct = 0x7C4CB4; //0x7C2D90
		else if (slotType == "COND_2CYB") condFunct = 0x7C4D1C; //0x7C2DF8
		else if (slotType == "COND_2SCO") condFunct = 0x7C4D84; //0x7C2E60
		else if (slotType == "COND_2DDR") condFunct = 0x7C4DEC; //0x7C2EC8
		else if (slotType == "COND_3HNZ") condFunct = 0x7C4E54; //0x7C2F30
		else if (slotType == "COND_3TOB") condFunct = 0x7C4EBC; //0x7C2F98
		else if (slotType == "COND_3TYO") condFunct = 0x7C3E14; //0x7C3000
		else if (slotType == "COND_3MDR_2") condFunct = 0x7C4F24; //0x7C3068
		else if (slotType == "COND_3KBT") condFunct = 0x7C4F8C; //0x7C30D0
		else if (slotType == "COND_2KNK") condFunct = 0x7C4FF4; //0x7C3138
		else if (slotType == "COND_2JRY") condFunct = 0x7C505C; //0x7C31A0
		else if (slotType == "COND_3GAR") condFunct = 0x7C50C4; //0x7C3208
		else if (slotType == "COND_2GAV") condFunct = 0x7C50C4; //0x7C3208
		else if (slotType == "COND_2ORC") condFunct = 0x7C512C; //0x7C3270
		else if (slotType == "COND_5KGY") condFunct = 0x7C5194; //0x7C32D8
		else if (slotType == "COND_2FOU") condFunct = 0x7C51FC; //0x7C3340
		else if (slotType == "COND_2DNZ") condFunct = 0x7C5264; //0x7C33A8
		else if (slotType == "COND_3GUY") condFunct = 0x7C52CC; //0x7C3410
		else if (slotType == "COND_2KBT") condFunct = 0x7C317C; //0x7C3478
		else if (slotType == "COND_2MDR") condFunct = 0x7C31E4; //0x7C34E0
		else if (slotType == "COND_JKKS") condFunct = 0x7C324C; //0x7C3548
		else if (slotType == "COND_2KIB") condFunct = 0x7C32B4; //0x7C35B0
		else if (slotType == "COND_2KNN") condFunct = 0x7C331C; //0x7C1460
		else if (slotType == "COND_2SGT") condFunct = 0x7C3384; //0x7C14C8
		else if (slotType == "COND_4MKG") condFunct = 0x7C33EC; //0x7C1530
		else if (slotType == "COND_2NRT") condFunct = 0x7C3454; //0x7C1598
		else if (slotType == "COND_2NRG") condFunct = 0x7C3454; //0x7C1598
		else if (slotType == "COND_3NRT") condFunct = 0x7C3454; //0x7C1598
		else if (slotType == "COND_2NRX") condFunct = 0x7C34BC; //0x7C1600
		else if (slotType == "COND_3SSK") condFunct = 0x7C3524; //0x7C1668
		else if (slotType == "COND_5TYY") condFunct = 0x7C358C; //0x7C16D0
		else if (slotType == "COND_5MDR") condFunct = 0x7C35F4; //0x7C1738
		else if (slotType == "COND_5KDM") condFunct = 0x7C365C; //0x7C17A0
		else if (slotType == "COND_BMDR") condFunct = 0x7C36C4; //0x7C1808
		else if (slotType == "COND_1KNK") condFunct = 0x7C372C; //0x7C1870
		else if (slotType == "COND_2YMT") condFunct = 0x7C3794; //0x7C18D8
		else if (slotType == "COND_3MDR") condFunct = 0x7C37FC; //0x7C1940
		else if (slotType == "COND_5SKN") condFunct = 0x7C3864; //0x7C19A8
		else if (slotType == "COND_5JRB") condFunct = 0x7C383C; //0x7C1A10
		else if (slotType == "COND_7BRX") condFunct = 0x7C3934; //0x7C1A78
		else if (slotType == "COND_7SKD") condFunct = 0x7C399C; //0x7C1AE0
		else if (slotType == "COND_7YRI") condFunct = 0x7C3A04; //0x7C1B48
		else if (slotType == "COND_7NRN") condFunct = 0x7C3A6C; //0x7C1BB0
		else if (slotType == "COND_7SSX") condFunct = 0x7C3AD4; //0x7C1C18
		else if (slotType == "COND_7MMS") condFunct = 0x7C3B3C; //0x7C1C80
		else if (slotType == "COND_7KIN") condFunct = 0x7C3BA4; //0x7C1CE8
		else if (slotType == "COND_7GAR") condFunct = 0x7C50C4; //0x7C3208
		else if (slotType == "COND_7MTK") condFunct = 0x7C3C0C; //0x7C1D50
		else if (slotType == "COND_8MMS") condFunct = 0x7C3C74; //0x7C1DB8
		else if (slotType == "COND_8KIN") condFunct = 0x7C3CDC; //0x7C1E20
		else if (slotType == "COND_8KNK") condFunct = 0x7C3D44; //0x7C1E88
		else if (slotType == "COND_8SIK") condFunct = 0x7C3DAC; //0x7C1EF0
		else if (slotType == "COND_8TYO") condFunct = 0x7C3E14; //0x7C3000
		else if (slotType == "COND_BKRL") condFunct = 0x7C3E7C; //0x7C1F58
		else if (slotType == "COND_BSSN") condFunct = 0x7C3EE4; //0x7C1FC0
		else if (slotType == "COND_BOBT") condFunct = 0x7C3F4C; //0x7C2028
		else if (slotType == "COND_BKRS") condFunct = 0x7C3FB4; //0x7C2090
		else if (slotType == "COND_B3HS") condFunct = 0x7C401C; //0x7C20F8
		else if (slotType == "COND_BGKT") condFunct = 0x7C4084; //0x7C2160
		else if (slotType == "COND_BAOD") condFunct = 0x7C40EC; //0x7C21C8
		else if (slotType == "COND_BKTY") condFunct = 0x7C4154; //0x7C2230
		else if (slotType == "COND_1JBR") condFunct = 0x7C41BC; //0x7C2298
		else if (slotType == "COND_2JBR") condFunct = 0x7C4224; //0x7C2300
		else if (slotType == "COND_3JBR") condFunct = 0x7C428C; //0x7C2368
		else if (slotType == "COND_4JBR") condFunct = 0x7C42F4; //0x7C23D0
		else if (slotType == "COND_5JBR") condFunct = 0x7C435C; //0x7C2438
		else if (slotType == "COND_6JBR") condFunct = 0x7C43C4; //0x7C24A0
		else if (slotType == "COND_BJYD") condFunct = 0x7C442C; //0x7C2508
		else if (slotType == "COND_GFSA") condFunct = 0x7C4494; //0x7C2570
		else if (slotType == "COND_BKKX") condFunct = 0x7C44FC; //0x7C25D8
		else if (slotType == "COND_B5OB") condFunct = 0x7C4564; //0x7C2640
		else if (slotType == "COND_B4NR") condFunct = 0x7C45CC; //0x7C26A8
		else if (slotType == "COND_B2NR") condFunct = 0x7C4634; //0x7C2710
		else if (slotType == "COND_BJB1") condFunct = 0x7C469C; //0x7C2778
		else if (slotType == "COND_BJB2") condFunct = 0x7C469C;	//0x7C2778
		else if (slotType == "COND_BJB3") condFunct = 0x7C469C;	//0x7C2778
		else if (slotType == "COND_BJB4") condFunct = 0x7C469C;	//0x7C2778
		else if (slotType == "COND_GFSA") condFunct = 0x7C469C;	//0x7C2778
		else if (slotType == "COND_BGRG") condFunct = 0x7C27E0; //0x7C27E0
		else if (slotType == "COND_GZTU") condFunct = 0x7C476C; //0x7C2848
		else if (slotType == "COND_BRSK") condFunct = 0x7C47D4; //0x7C28B0
		else if (slotType == "COND_BKMS") condFunct = 0x7C483C; //0x7C2918
		else if (slotType == "COND_BKSR") condFunct = 0x7C48A4; //0x7C2980
		else if (slotType == "COND_BOBK") condFunct = 0x7C490C; //0x7C29E8
		else if (slotType == "COND_BNRX") condFunct = 0x7C4974; //0x7C2A50
		else if (slotType == "COND_BSSX") condFunct = 0x7C49DC;	//0x7C2AB8
		else if (slotType == "COND_BISS") condFunct = 0x7C4A44; //0x7C2B20
		else if (slotType == "COND_BMNK") condFunct = 0x7C4AAC; //0x7C2B88
		else if (slotType == "COND_7MMV") condFunct = 0x7C4B14; //0x7C2BF0
