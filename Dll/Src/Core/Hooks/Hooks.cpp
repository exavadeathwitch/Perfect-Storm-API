...
namespace hooks {
    void hookImportant() {
        ...
        globals::hookManager->addEntry(GetAddressFromSignature({ 0x48, 0x89, 0x74, 0x24, -1, 0x57, 0x48, 0x83, 0xec, -1, 0x48, 0x8b, 0x41, -1, 0x4c, 0x8d, 0x41, -1, 0x8b, 0xfa, 0x48, 0x8b, 0xf1, 0xba, -1, -1, -1, -1 }, globals::moduleBase + 0xA90000, globals::moduleBase + 0xAE0000), ccSceneManager::Push);
...
0x48, 0xff, 0xcf, 0x75, -1, 0x48, 0x8b, 0x5c, 0x24, -1, 0x48, 0x83, 0xc4, -1 }, globals::moduleBase + 0x5C0000, globals::moduleBase + 0x620000), misc::initCharselModel);
        ...
        globals::hookManager->addEntry(GetAddressFromSignature({ 0x48, 0x83, 0xec, -1, 0x48, 0x85, 0xc9, 0x74, -1, 0x48, 0x8b, 0xd1, 0x48, 0x8b, 0x0d, -1, -1, -1, -1, 0xe8, -1, -1, -1, -1, 0x48, 0x85, 0xc0 }, globals::moduleBase + 0xAA0000, globals::moduleBase + 0xAF0000), ccUiGetMessage);
        
        globals::hookManager->addEntry(GetAddressFromSignature({ 0x4c, 0x8b, 0x91, -1, -1, -1, -1, 0x41, 0x83, 0xc9 }, globals::moduleBase + 0x9E0000, globals::moduleBase + 0xA60000), nuccSys::GetControllerActiveUser);
        
        globals::hookManager->addEntry(GetAddressFromSignature({ 0x83, 0xf9, -1, 0x77, -1, 0x48, 0x8b, 0x15 }, globals::moduleBase + 0x800000, globals::moduleBase + 0x870000), ccGame_GetPlayerLeader);
